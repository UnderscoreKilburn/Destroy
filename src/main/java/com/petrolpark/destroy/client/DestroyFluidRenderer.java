...
public class DestroyFluidRenderer {
    ...
    /**
     * Copied from {@link FluidRenderHelper#renderFluidBox(FluidStack, float, float, float, float, float, float, VertexConsumer, PoseStack, int, boolean) Create 0.5.1 source code}.
     * @param fluidStack
     * @param xMin
     * @param yMin
     * @param zMin
